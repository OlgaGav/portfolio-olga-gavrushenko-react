    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-sm-10 col-md-7 col-lg-7 align-self-center">
          <p>
            I am certified Full Stack Developer. Completed Berkley UC Bootcamp. What I've learned and practice in small and bigger projects, you can see them in my portfolio: HTML5, CSS3, JavaScript, jQuery, Bootstrap, Express.js, React.js, databases, MongoDB, Node.js, MySQL, Command Line, Git and more.   
          </p>
          <p>
            In background I have progressive experiense in Quality Assuranse.
            Expertise in creating detailed test plans, test cases for manual and
            automation testing within the application under test, testing
